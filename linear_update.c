...
PetscErrorCode calc_residual_linear_algebraic(SNES snes,Vec current_state,Vec Res,void *ctx)
{
            ...
            for(ion=0;ion<Ni;ion++) {
                for(comp=0;comp<Nc-1;comp++) {
                    ...
                    if(x>0) {
                        ...
                        // C term
                        Rcvx = Dcs[c_index(x - 1, y, 0, comp, ion, Nx, 0) * 2] * (c[c_index(x, y, 0, comp, ion, Nx,
                                                                                            0)] - c[c_index(x - 1, y, 0,
                                                                                                            comp, ion,
                                                                                                            Nx,
                                                                                                            0)]);
                        ...
                        Rcvx += Dcs[c_index(x - 1, y, 0, comp, ion, Nx, 0) * 2] * z_charge[ion] * (cp[c_index(x - 1, y, 0,
                                ...
                                ion,
                                Nx,
                                0)]) / 2 * (phi[phi_index(x, y, 0, comp, Nx, 0)] - phi[phi_index(x - 1, y, 0, comp, Nx,
                                                                                                 0)]);
                        Rcvx = Rcvx/dx*dt/dx;
                    }
                    ...
                    if(x<Nx-1) {
                        // C term
                        RcvxRight = Dcs[c_index(x, y, 0, comp, ion, Nx, 0) * 2] * (c[c_index(x + 1, y, 0, comp, ion, Nx,
                                                                                             0)] - c[c_index(x, y, 0,
                                                                                                             comp, ion,
                                                                                                             Nx, 0)]);
                        //Phi term
                    ...
                    if(y>0) {
                        // C term
                        Rcvy = Dcs[c_index(x, y - 1, 0, comp, ion, Nx, 0) * 2 + 1] * (c[c_index(x, y, 0, comp, ion, Nx,
                                                                                                0)] - c[c_index(x,
                                                                                                                y - 1, 0,
                                                                                                                comp,
                                                                                                                ion, Nx,
                        ...
                        Rcvy += Dcs[c_index(x, y - 1, 0, comp, ion, Nx, 0) * 2 + 1] * z_charge[ion] * (cp[c_index(x, y - 1, 0,
                                ...
                                ion,
                                Nx,
                                0)]) / 2 * (phi[phi_index(x, y, 0, comp, Nx, 0)] - phi[phi_index(x, y - 1, 0, comp, Nx,
                                                                                                 0)]);
                        Rcvy = Rcvy/dy*dt/dy;
                    }
                    ...
                    if(y<Ny-1) {
                        // C term
                        RcvyUp = Dcs[c_index(x, y, 0, comp, ion, Nx, 0) * 2 + 1] * (c[c_index(x, y + 1, 0, comp, ion,
                                                                                              Nx, 0)] - c[c_index(x, y,
                                                                                                                  0,
                                                                                                                  comp,
                                                                                                                  ion,
                        ...
                        RcvyUp += Dcs[c_index(x, y, 0, comp, ion, Nx, 0) * 2 + 1] * z_charge[ion] * (cp[c_index(x, y + 1, 0,
                                ...
                                ion,
                                Nx,
                                0)]) / 2 * (phi[phi_index(x, y + 1, 0, comp, Nx, 0)] - phi[phi_index(x, y, 0, comp, Nx,
                                                                                                     0)]);
                ...
                if(x>0) {
                    //First difference term
                    // C term
                    Rcvx = Dcs[c_index(x - 1, y, 0, comp, ion, Nx, 0) * 2] * (c[c_index(x, y, 0, comp, ion, Nx, 0)] - c[c_index(
                            x - 1, y, 0, comp,
                            ion, Nx, 0)]);
                    //Phi term
                    Rcvx += Dcs[c_index(x - 1, y, 0, comp, ion, Nx, 0) * 2] * z_charge[ion] * (cp[c_index(x - 1, y, 0, comp,
                            ...
                            comp,
                            ion, Nx,
                            0)]) / 2 * (phi[phi_index(x, y, 0, comp, Nx, 0)] - phi[phi_index(x - 1, y, 0, comp, Nx, 0)]);
                    Rcvx = Rcvx/dx*dt/dx;
                }
                //Add Second right moving difference
                if(x<Nx-1) {
                    ...
                    RcvxRight += Dcs[c_index(x, y, 0, comp, ion, Nx, 0) * 2] * z_charge[ion] * (cp[c_index(x + 1, y, 0, comp,
                            ...
                            ion,
                            Nx,
                            0)]) / 2 * (phi[phi_index(x + 1, y, 0, comp, Nx, 0)] - phi[phi_index(x, y, 0, comp, Nx, 0)]);
                    RcvxRight = RcvxRight/dx*dt/dx;
                }
                Rcvy = 0;
                RcvyUp = 0;
                ...
                if(y>0) {
                    ...
                    Rcvy += Dcs[c_index(x, y - 1, 0, comp, ion, Nx, 0) * 2 + 1] * z_charge[ion] * (cp[c_index(x, y - 1, 0,
                            ...
                            comp,
                            ion,
                            Nx, 0)]) / 2 * (phi[phi_index(x, y, 0, comp, Nx, 0)] - phi[phi_index(x, y - 1, 0, comp, Nx,
                                                                                                 0)]);
                    Rcvy = Rcvy/dy*dt/dy;
                }
                //Next upward difference
                if(y<Ny-1) {
                    // C term
                    RcvyUp = Dcs[c_index(x, y, 0, comp, ion, Nx, 0) * 2 + 1] * (c[c_index(x, y + 1, 0, comp, ion, Nx,
                                                                                          0)] - c[c_index(x, y, 0, comp,
                                                                                                          ion, Nx, 0)]);
                    //Phi term
                    RcvyUp += Dcs[c_index(x, y, 0, comp, ion, Nx, 0) * 2 + 1] * z_charge[ion] * (cp[c_index(x, y + 1, 0, comp,
                            ...
                            comp,
                            ion,
                            Nx, 0)]) / 2 * (phi[phi_index(x, y + 1, 0, comp, Nx, 0)] - phi[phi_index(x, y, 0, comp, Nx,
                                                                                                     0)]);
                    RcvyUp = RcvyUp/dy*dt/dy;
                }
    ...
    for(x=0;x<Nx;x++)
    {
        for(y=0;y<Ny;y++)
        {
            ...
            {
                //Extracell voltage
                ierr = VecSetValue(Res, Ind_1(x, y, 0, Ni, Nc - 1, Nx, 0), -cm[al_index(x,y,0,comp,Nx,Ny)] * (phi[phi_index(x, y, 0, Nc - 1, Nx, 0)] - phi[phi_index(
                        x, y,
                        0,
                        comp,
                        Nx, 0)]), ADD_VALUES);CHKERRQ(ierr);
                //Intracell voltage mod
                ierr = VecSetValue(Res, Ind_1(x, y, 0, Ni, comp, Nx, 0), -cm[al_index(x,y,0,comp,Nx,Ny)] * (phi[phi_index(x, y, 0, comp, Nx, 0)] - phi[phi_index(
                        x, y,
                        0,
                        Nc -
                        1, Nx,
    ...
    if(iter==0) {
                ...
                for (ion = 0; ion < Ni; ion++) {
                    for (comp = 0; comp < Nc - 1; comp++) {
                        ...
                        if (x < Nx - 1) {
                            ...
                            ierr = MatSetValue(Jac, Ind_1(x + 1, y, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx,
                                                                                                0), -Fc0x,
                                               INSERT_VALUES);
                            CHKERRQ(ierr);
                            ind++;
                            //Right c with left phi (-Fph0x)
                            ierr = MatSetValue(Jac, Ind_1(x + 1, y, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), -Fph0x,
                                               INSERT_VALUES);
                            CHKERRQ(ierr);
                            ind++;
                        ...
                        if (x > 0) {
                            ...
                            ierr = MatSetValue(Jac, Ind_1(x - 1, y, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), -Fph1x,
                                               INSERT_VALUES);
                            CHKERRQ(ierr);
                            ind++;
                        }
                        if (y < Ny - 1) {
                            ...
                            ierr = MatSetValue(Jac, Ind_1(x, y + 1, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx,
                                                                                                0), -Fc0y,
                                               INSERT_VALUES);
                            CHKERRQ(ierr);
                            ind++;
                            //Upper c with lower phi (-Fph0y)
                            ierr = MatSetValue(Jac, Ind_1(x, y + 1, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), -Fph0y,
                                               INSERT_VALUES);
                            CHKERRQ(ierr);
                            ind++;
                        }
                        if (y > 0) {
                            ...
                            ierr = MatSetValue(Jac, Ind_1(x, y - 1, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), -Fph1y,
                                               INSERT_VALUES);
                            CHKERRQ(ierr);
                            ind++;
                        }
                    ...
                    Ac -= sqrt(pow(Dcb[c_index(x, y, 0, Nc - 1, ion, Nx, 0) * 2], 2) +
        ...
        for (x = 0; x < Nx; x++) {
            for (y = 0; y < Ny; y++) {
                ...
                Aphi = 0;
                for (comp = 0; comp < Nc - 1; comp++) {
                    Aphi -= cm[al_index(x,y,0,comp,Nx,Ny)];
                }
                ...
                for (comp = 0; comp < Nc - 1; comp++) {
                    ...
                    ierr = MatSetValue(Jac, Ind_1(x, y, 0, Ni, Nc - 1, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), cm[al_index(x,y,0,comp,Nx,Ny)], INSERT_VALUES);
                    CHKERRQ(ierr);
                    ind++;
                    // Intra phi with Extraphi
                    ierr = MatSetValue(Jac, Ind_1(x, y, 0, Ni, comp, Nx, 0), Ind_1(x, y, 0, Ni, Nc - 1, Nx, 0), cm[al_index(x,y,0,comp,Nx,Ny)], INSERT_VALUES);
                    CHKERRQ(ierr);
                    ind++;
                    //Intra phi with Intra phi
                    ierr = MatSetValue(Jac, Ind_1(x, y, 0, Ni, comp, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), -cm[al_index(x,y,0,comp,Nx,Ny)], INSERT_VALUES);
                    CHKERRQ(ierr);
                    ind++;
                }
            }
                    ...
                    for (comp = 0; comp < Nc - 1; comp++) {
                        ...
                        if (y > 0) {
                            ...
                            Fph1y = z_charge[ion] * Dcs[c_index(x, y - 1, 0, comp, ion, Nx, 0) * 2 + 1] * (cp[c_index(x, y - 1,
                                                                                                               ...
                                                                                                               ion, Nx,
                                                                                                               0)] + cp[c_index(
                                    x, y, 0, comp, ion, Nx, 0)]) / 2 / dy * dt / dy;
                        }
                        //Diagonal term contribution
                        Ac = al[al_index(x, y, 0, comp, Nx, 0)] + Fc0x + Fc1x + Fc0y + Fc1y;
                        Aphi = Fph0x + Fph1x + Fph0y + Fph1y;
                        ...
                        // Different Compartment Terms
                        // C Extracellular with C Inside
                        ierr = MatSetValue(Jac, Ind_1(x, y, 0, ion, Nc - 1, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx, 0), -flux->dfdci[c_index(
...
PetscErrorCode calc_residual_linear_deriv(SNES snes,Vec current_state,Vec Res,void *ctx)
{
    ...
    for(x=0;x<Nx;x++) {
        for(y=0;y<Ny;y++) {
            ...
            ResphN = 0;
            for(comp=0;comp<Nc-1;comp++) {
                Resph = cm[al_index(x,y,0,comp,Nx,Ny)]*(phi[phi_index(x, y, 0, comp, Nx, 0)] - phi[phi_index(x, y, 0, Nc - 1, Nx, 0)]) - cm[al_index(x,y,0,comp,Nx,Ny)] * (phip[phi_index(
                        x,
                        y,
                        0,
                        comp,
        ...
        for(x=0;x<Nx;x++) {
            for(y=0;y<Ny;y++) {
                ...
                for(ion=0;ion<Ni;ion++) {
                    for(comp=0;comp<Nc-1;comp++) {
                        ...
                        if(x<Nx-1) {
                            ...
                            // Right c with left c (-Fc0x)
                            ierr = MatSetValue(Jac, Ind_1(x + 1, y, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx,
                                                                                                0), -Fc0x, INSERT_VALUES);CHKERRQ(ierr);
                            ind++;
                            //Right c with left phi (-Fph0x)
                        ...
                        if(x>0) {
                            ...
                            //left c with right c (-Fc1x)
                            ierr = MatSetValue(Jac, Ind_1(x - 1, y, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx,
                                                                                                0), -Fc1x, INSERT_VALUES);CHKERRQ(ierr);
                            ind++;
                            //Left c with right phi (-Fph1x)
                        ...
                        if(y<Ny-1) {
                            ...
                            // Upper c with lower c (-Fc0y)
                            ierr = MatSetValue(Jac, Ind_1(x, y + 1, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx,
                                                                                                0), -Fc0y, INSERT_VALUES);CHKERRQ(ierr);
                            ind++;
                            //Upper c with lower phi (-Fph0y)
                        ...
                        if(y>0) {
                            ...
                            //Lower c with Upper c (-Fc1y)
                            ierr = MatSetValue(Jac, Ind_1(x, y - 1, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx,
                                                                                                0), -Fc1y, INSERT_VALUES);CHKERRQ(ierr);
                            ind++;
                            //Lower c with Upper phi (-Fph1y)
                        ...
                        // Different Compartment Terms
                        // C Extracellular with C Inside
                        ierr = MatSetValue(Jac, Ind_1(x, y, 0, ion, Nc - 1, Nx, 0), Ind_1(x, y, 0, ion, comp, Nx, 0), -flux->dfdci[c_index(x,
                                                                                                                                           y,
                                                                                                                                           0,
                                                                                                                                           comp,
                                                                                                                                           ion,
                        ...
                        ind++;
                        // C Intra with C Extra
                        ierr = MatSetValue(Jac, Ind_1(x, y, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, ion, Nc - 1, Nx, 0), flux->dfdce[c_index(x,
                                                                                                                                          y,
                                                                                                                                          0,
                                                                                                                                          comp,
                                                                                                                                          ion,
                        ...
                        ind++;
                        // C Extracellular with Phi Inside
                        ierr = MatSetValue(Jac, Ind_1(x, y, 0, ion, Nc - 1, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), -flux->dfdphim[c_index(x,
                                                                                                                                            y,
                                                                                                                                            0,
                                                                                                                                            comp,
                                                                                                                                            ion,
                        ...
                        ind++;
                        // C Intra with Phi Extra
                        ierr = MatSetValue(Jac, Ind_1(x, y, 0, ion, comp, Nx, 0), Ind_1(x, y, 0, Ni, Nc - 1, Nx, 0), -flux->dfdphim[c_index(x,
                                                                                                                                            y,
                                                                                                                                            0,
                                                                                                                                            comp,
                                                                                                                                            ion,
                ...
                for(comp=0;comp<Nc-1;comp++) {
                    ...
                    Avolt = cm[al_index(x,y,0,comp,Nx,Ny)]+Fphph0x[comp]+Fphph1x[comp]+Fphph0y[comp]+Fphph1y[comp];
                    AvoltN = -cm[al_index(x,y,0,comp,Nx,Ny)];
                    for(ion=0;ion<Ni;ion++) {
                ...
                for(int k=0;k<Nc-1;k++) {
                    AvoltN += cm[al_index(x,y,0,comp,Nx,Ny)];
                    Avolt = -cm[al_index(x,y,0,comp,Nx,Ny)];
                    for(ion=0;ion<Ni;ion++) {
        ...
        for (x = 0; x < Nx; x++) {
            for (y = 0; y < Ny; y++) {
                ...
                for (ion = 0; ion < Ni; ion++) {
                    ...
                    //phi with c (voltage eqn)
                    ierr = MatSetValue(Jac, Ind_1(x, y, 0, Ni, Nc - 1, Nx, 0), Ind_1(x, y, 0, ion, Nc - 1, Nx, 0), Avolt, INSERT_VALUES);
                    CHKERRQ(ierr);
                    ind++;
                }
                //Derivative of charge-capacitance
                for (comp = 0; comp < Nc - 1; comp++) {
                    ...
                    //Intra-phi with Intra-phi
                    ierr = MatSetValue(Jac, Ind_1(x, y, 0, Ni, comp, Nx, 0), Ind_1(x, y, 0, Ni, comp, Nx, 0), Avolt, INSERT_VALUES);
                    CHKERRQ(ierr);
                    ind++;
                    //Intra-phi with extra-phi
                    ierr = MatSetValue(Jac, Ind_1(x, y, 0, Ni, comp, Nx, 0), Ind_1(x, y, 0, Ni, Nc - 1, Nx, 0), AvoltN, INSERT_VALUES);
                    CHKERRQ(ierr);
                    ind++;
                }
                //Extracellular terms
