...
* initialize.c: Initialize everything from structures, petsc, variables, parameters, initial steady state. Also contains indexing routines.
...
* data_csd.txt: Simulation results.
