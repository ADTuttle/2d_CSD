...
csd: 
	...
	gcc -O3 -g -o multirate_update.o -c $(Flags) $(Includes) $(CSD_Includes) `pwd`/multirate_update.c

	gcc -O3 $(LFlags)   -o csd constants.o multirate_update.o linear_update.o initialize.o csd_main.o ion_channel.o array_function.o update_solution.o misc_print_plot.o $(Linker) -lpetsc -lf2clapack -lf2cblas -lX11 -ldl 
	#View assembly file?
	...
	rm csd_main.o constants.o multirate_update.o initialize.o linear_update.o ion_channel.o array_function.o update_solution.o misc_print_plot.o
