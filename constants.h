...
#define glut_A  100e-5 //100e-5//500e-5 //(500e-3) //500       //Release rate in mmol/cm^3/sec
...
#define glut_Bg (1.0/42) //(1.0/84) //8e-2             //Decay rate(glia->neurons) in 1/sec
#define pNaGl_n 0 //(5e-3*RTFC/FC)              //Na-Glu transporter permeability
#define pNaGl_g (3e-3*RTFC/FC) //(3e-3*RTFC/FC)              //Na-Glu transporter permeability
...
#define glut_gamma 0.2 //0.2    //Reabsorbtion ratio (arbitrary)
